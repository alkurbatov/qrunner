...
on run argv
	tell application "Safari"
		activate
		open location "https://developer.mozilla.org/ru/search?q=" & argv & "&topic=apps&topic=html&topic=css&topic=js&topic=api&topic=canvas&topic=svg&topic=webgl&topic=mobile&topic=webdev&topic=http&topic=webext"
	end tell
end run
